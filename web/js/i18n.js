...
const STRINGS = {
  en: {
    ...
    'cover.sub': '— constant decoy packets hide when you talk',
    'logout': 'Logout',
    'chat.burn': '🔥 Burn',
    ...
    'qr.hint': "Point your camera at your peer's screen (and let them scan yours). The codes are compared automatically — a match proves no one is in the middle.",
    'qr.close': 'Close',
    'qr.scanning': 'Scanning…',
    'qr.match': '✓ Codes match — the line is secure',
  ...
  ro: {
    ...
    'cover.sub': '— pachete-momeală constante ascund când vorbești',
    'logout': 'Deconectare',
    'chat.burn': '🔥 Ardere',
    ...
    'qr.hint': 'Îndreaptă camera spre ecranul partenerului (și lasă-l să-l scaneze pe al tău). Codurile se compară automat — dacă se potrivesc, nimeni nu e la mijloc.',
    'qr.close': 'Închide',
    'qr.scanning': 'Se scanează…',
    'qr.match': '✓ Codurile se potrivesc — linia e sigură',
