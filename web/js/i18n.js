...
const STRINGS = {
  en: {
    ...
    'auth.hint': 'SRP accounts do not send the password. Legacy accounts send it once to upgrade. No email. No recovery. Registration needs an invite code.',
    'auth.hintOpen': 'SRP accounts do not send the password. Legacy accounts send it once to upgrade. No email or recovery. Registration is open.',
  ...
  ro: {
    ...
    'auth.hint': 'Conturile SRP nu trimit parola. Conturile vechi o trimit o dată pentru migrare. Fără email sau recuperare. Înregistrarea cere invitație.',
    'auth.hintOpen': 'Conturile SRP nu trimit parola. Conturile vechi o trimit o dată pentru migrare. Fără email sau recuperare. Înregistrarea este deschisă.',
